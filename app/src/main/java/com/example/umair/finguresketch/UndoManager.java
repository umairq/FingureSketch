...
public class UndoManager 
	...
	private FingerWriterActivity main;
	
	public static void setApplication(FingerWriterActivity app) {
		getUndoManager().main = app;
	}
	
	protected static FingerWriterActivity getApplication() {
		FingerWriterActivity result = getUndoManager().main;
	...
	public boolean undo() {
		...
		if (cmd == null)
			return false;
		FingerWriterActivity activity = getApplication();
		activity.toast(activity.getString(R.string.finger_sketch_undo) + ": "+cmd.toString());
		cmd.revert();
	...
	public boolean redo() {
		...
		cmd.execute();
		FingerWriterActivity activity = getApplication();
		activity.toast(activity.getString(R.string.finger_sketch_redo) + ": "+cmd.toString());
		undoStack.addFirst(cmd);
		return true;	
	}
