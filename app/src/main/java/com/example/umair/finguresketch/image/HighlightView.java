...
package com.example.umair.finguresketch.image;
...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.image_editor_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.image_editor_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.image_editor_crop_auto);
    }
