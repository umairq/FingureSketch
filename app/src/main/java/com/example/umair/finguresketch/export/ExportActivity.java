package com.example.umair.finguresketch.export;
...
import com.example.umair.finguresketch.PDFExporter;
import com.example.umair.finguresketch.R;
import com.example.umair.finguresketch.R.array;
...
import com.example.umair.finguresketch.artist.PaperType;
...
public class ExportActivity 
	...
	public void onItemSelectedFormat(int position) {
		...
		case OUTPUT_FORMAT_BACKUP:  // Quill backup archive
			...
			exportSizes.clear();
        	exportSizes.notifyDataSetChanged();
        	changeFileExtensionTo(".finger_sketch");
        	mimeType = "application/vnd.name.vbraun.finger_sketch";
			return;
		}		
	}
