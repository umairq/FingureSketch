...
public class Toolbox 
	...
	protected ImageButton fountainpenButton, pencilButton, lineButton, keyboardtextButton;
	...
	protected Toolbox(Context context, boolean left) {
		...
		keyboardtextButton = (ImageButton) findViewById(R.id.toolbox_KeyBoardText);
		...
		quillButton  = (ImageButton) findViewById(R.id.toolbox_finger_sketch_icon);
		...
		keyboardtextButton.setOnClickListener(this);
